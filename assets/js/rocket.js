...
(function() {
    ...
    function svgPlay(color) {
      var svg = createEl('svg', {width: 16, height: 20}),
    ...
    function svgPause(color) {
      var svg = createEl('svg', {width: 16, height: 20}),
          rect = createEl('rect', {width: 5, height: 20, style: 'fill:' + color}),
          rect2 = createEl('rect', {x: 7, width: 5, height: 20, style: 'fill:' + color});
